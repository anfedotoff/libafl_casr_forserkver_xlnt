...
use libafl::{
    ...
    feedbacks::{CrashFeedback, MaxMapFeedback, TimeFeedback, NewHashFeedback},
    fuzzer::{Fuzzer, StdFuzzer},
    inputs::BytesInput,
    monitors::SimpleMonitor,
    mutators::{scheduled::havoc_mutations, tokens_mutations, StdScheduledMutator, Tokens},
    observers::{AsanBacktraceObserver, HitcountsMapObserver, StdMapObserver, TimeObserver},
...
pub fn main() {
    ...
    let _ = SimpleStderrLogger::set_logger();
    ...
    let mut forkserver = ForkserverExecutor::builder()
        ...
        .build(tuple_list!(bt_observer, time_observer, edges_observer))
        .unwrap();
